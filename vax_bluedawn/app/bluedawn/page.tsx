        ...
        <div className="h-[80vh] flex flex-col justify-between items-center py-2">
            <div>
                ...
                <div className="flex flex-col items-center gap-6">
                    <h1 className="text-white font-bold text-2xl md:text-3xl text-center max-w-[80vw] md:max-w-[500px]">A blue dawn arises between the night sky and the sunrise.</h1>
