...
export default function TrackModal( {track, onClose} : Props) {
    return (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50" onClick={onClose}>
            ...
            <div className=
            "bg-black flex flex-col justify-center items-center border border-blue-500 border-4 gap-2 w-[90vw] max-w-[500px] md:max-w-[600px] md:h-[40vh] ring-white ring-2" 
