...
export default function TrackCard( { track, onClick, isSelected } : Props) {
    ...
    <div
      ...
      `}
    >
      <h1 className="text-xl lg:text-4xl [text-shadow:_2px_0_0_blue,_-2px_0_0_blue,_0_2px_0_blue,_0_-2px_0_blue] hover:text-blue-400 hover:scale-120">{track.name}</h1>
    </div>
