...
export default function TrackCard( { track, onClick, isSelected } : Props) {
    ...
    <div
      onClick={onClick}
      className={`cursor-pointer text-center text-2xl [text-shadow:_2px_0_0_blue,_-2px_0_0_blue,_0_2px_0_blue,_0_-2px_0_blue] hover:text-blue-400 hover:scale-140
